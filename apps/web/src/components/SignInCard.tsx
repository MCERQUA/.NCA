        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-slate">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 text-charcoal rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2"
          >
